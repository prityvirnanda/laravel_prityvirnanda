                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col mb-5">
                        <div class="card" style="width: 18rem;">
                            <img src="{{ asset('image/tt.jpeg') }}" class="card-img-top" alt="" width="300" height="300">
                            <div class="card-body">
                    ...
                    <div class="col mb-5">
                        <div class="card" style="width: 18rem;">
                            <img src="{{ asset('image/poltek.jpg') }}" class="card-img-top" alt="" width="300" height="300">
                            <div class="card-body">
                    ...
                    <div class="col mb-5">
                        <div class="card" style="width: 18rem;">
                            <img src="{{ asset('image/th.jpeg') }}" class="card-img-top" alt="" width="300" height="300">
                            <div class="card-body">
