...
<body>
    ...
    <article>
        ...
        <p>
            "Saya adalah mahasiswa semester 5 di Politeknik Negeri Bengkalis<br>
             Jurusan Teknik Informatika dengan program studi Keamanan Sistem Informasi<br>
             Angkatan 2021. Hobby saya adalah mengambar dan membaca novel."
        </p>
    </article>
        ...
        <table border="1" width="100%">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <ul>
                            <li>Himpunan Teknik Informatika</li>
                            <li>Divisi kominfo di HMTI 23</li>
                            <li>UKM OLAHRAGA</li>
                        </ul>
                    </td>
                </tr>
    ...
    <hr>
    <footer>
        <p>Copyright 2023 @Prity Virnanda</p>
    </footer>
</body>
</html>
